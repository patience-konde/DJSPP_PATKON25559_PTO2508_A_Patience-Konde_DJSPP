/**
 * Genre metadata used throughout the app.
 * The actual show preview and detail data are loaded from the API.
 * @type {{id:number,title:string,description:string,shows:string[]}[]}
 */
export const genres = [
  {
    id: 1,
